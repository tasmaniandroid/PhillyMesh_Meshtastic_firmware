...
/* Solar Light Config */
typedef struct _meshtastic_ModuleConfig_SolarLightConfig {
    /* Preferences for the SolarLightModule */
    bool enabled;
} meshtastic_ModuleConfig_SolarLightConfig;
...
typedef struct _meshtastic_ModuleConfig {
    ...
    union {
        ...
        /* Solar lighting control module */
        meshtastic_ModuleConfig_SolarLightConfig solar_light;
    } payload_variant;
...
#define meshtastic_ModuleConfig_SolarLightConfig_init_default {0}
...
#define meshtastic_ModuleConfig_SolarLightConfig_init_zero {0}
...
#define meshtastic_ModuleConfig_SolarLightConfig_enabled_tag 1
...
#define meshtastic_ModuleConfig_solar_light_tag  17
...
X(a, STATIC,   ONEOF,    MESSAGE,  (payload_variant,solar_light,payload_variant.solar_light),  17)
...
#define meshtastic_ModuleConfig_payload_variant_solar_light_MSGTYPE meshtastic_ModuleConfig_SolarLightConfig
...
#define meshtastic_ModuleConfig_SolarLightConfig_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, BOOL,     enabled,           1)
#define meshtastic_ModuleConfig_SolarLightConfig_CALLBACK NULL
#define meshtastic_ModuleConfig_SolarLightConfig_DEFAULT NULL
...
extern const pb_msgdesc_t meshtastic_ModuleConfig_SolarLightConfig_msg;
...
#define meshtastic_ModuleConfig_SolarLightConfig_fields &meshtastic_ModuleConfig_SolarLightConfig_msg
...
#define meshtastic_ModuleConfig_SolarLightConfig_size 2
